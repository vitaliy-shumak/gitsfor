        ...
        return (
            <div className={passwordGroupClass}>
                ...
                <PasswordStrengthMeter
                    ...
                    password={password}
                    passwordFirstSolutions={this.props.passwordErrorFirstSolved}
                    passwordSecondSolutions={this.props.passwordErrorSecondSolved}
                    passwordThirdSolutions={this.props.passwordErrorThirdSolved}
